...
namespace Common
{
    ...
    public class DosProgressBar
    {
        ...
        public DosProgressBar() : this(Console.CursorLeft, Console.CursorTop, 50, ProgressBarType.Character)
        {

        }

        public DosProgressBar(int left, int top, int width, ProgressBarType ProgressBarType)
        {
            this.Left = left;
            this.Top = top;
            this.Width = width;
